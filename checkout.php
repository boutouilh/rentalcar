...
<div class="rq-cart-options-title">
<h4>MONTANT À PAYER : <?php echo $total;?> DH </h4>
</div>
<div class="rq-cart-options-content">
<input type="hidden" name="_token" value="TeOPtBQLUD9YG6jXE6Vuh4ZIJycDOOx0MjHBf1Ad">  <input type="hidden" name="price" value="280">
<input type="hidden" name="image" value="<?php echo $image; ?>">
          <input type="hidden" name="name" value="<?php echo $name; ?>">
          <input type="hidden" name="prix" value="<?php echo $prix; ?>">
          <input type="hidden" name="startdate" value="<?php echo $startdate; ?>">
          <input type="hidden" name="enddate" value="<?php echo $enddate; ?>">
		  <input type="hidden" name="interval" value="<?php echo $nbrejours ; ?>">
...
<ul class="rq-footer-social">
    <li><a href="https://www.facebook.com/people/PALACIO_Car/100075729044916/"target="_blank" ><i class="fa fa-facebook"></i> Facebook</a></li>
    <li><a href="https://instagram.com/palacio_car_" target="_blank" ><i class="fa fa-instagram"></i> Instagram</a></li>
    <li><a href="https://bit.ly/2ZHKUlX" target="_blank" ><i class="fa fa-whatsapp"></i> Whatsapp</a></li>
</ul>
</div>
</div> 
...
<script>
			$('#example').czmChatSupport({
				...
				popup: {
					...
					{
						avatar: {
							src: '<img src="https://netlify.app/images/logo1.jpeg" alt="">', /* Image, Icon or SVG */
